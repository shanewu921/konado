...
[クイックスタートガイド](https://godothub.com/oss/konado/ja/tutorial/install.html)に従って、数分以内に Konado をセットアップして使用を開始してください。


## ドキュメント

包括的なガイド、API リファレンス、高度なチュートリアルについては、公式プロジェクトウェブサイトをご覧ください：https://godothub.com/oss/konado/ja/
